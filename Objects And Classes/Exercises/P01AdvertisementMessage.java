...
public class P01AdvertisementMessage {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= n; i++) {
            String currentPhrase = phrases[getRandomIndex(phrases.length)];
            String currentEvent = events[getRandomIndex(events.length)];
            String currentAuthor = authors[getRandomIndex(authors.length)];
            String currentCity = cities[getRandomIndex(cities.length)];
